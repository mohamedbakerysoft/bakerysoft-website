...
<head>
    ...
    <title>BakerySoft</title>
    <link rel="stylesheet" href="./images/owl.carousel.min.css" />
<script defer src="./app.js"></script><link href="./main.css" rel="stylesheet"></head>

<body>
    <header>
        <nav class="navbar navbar-expand-lg fixed-top bg-transparent navbar-dark" id="main-nav">
            <div class="container">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-md-6 col-lg-6">
                        <div class="hero-content-left ptb-100 text-white">
                            <h1 class="text-white font-weight-bold mb-3">Best Way to Connect with Your Customers</h1>
                            <p class="lead">Conveniently generate multifunctional markets and B2C vortals. Uniquely
                                enable
                                inexpensive materials rather than sticky products target multidisciplinary process .</p>
                    ...
                    <div class="col-md-6 col-lg-5">
                        <div class="hero-animation-img">
                            <img class="img-fluid d-block animation-one" src="./images/hero-animation-04.svg"
                                alt="animation image">
                            <img class="img-fluid d-none d-lg-block animation-two" src="./images/hero-animation-01.svg"
                                alt="animation image" width="120">
                            <img class="img-fluid d-none d-lg-block animation-three"
                                src="./images/hero-animation-02.svg" alt="animation image" width="120">
                            <img class="img-fluid d-none d-lg-block animation-four" src="./images/hero-animation-03.svg"
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-8">
                    <div class="section-heading text-center mb-5">
                        <h2>Why Peoples Love BakerySoft?</h2>
                        <p class="lead">
                            Following reasons show advantages of adding BAKERYSOFT to your lead pages, demos and
                            checkouts productivate professional metrics rather.
                        </p>
                    </div>
                </div>
            </div>
            <div class="row equal">
                <div class="col-md-4 col-lg-4 promo-item mb-4">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-4">
                    <div class="download-img">
                        <img src="./images/image-10.png" alt="download" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="feature-contents section-heading">
                        ...
                        <p class="lead">Objectively deliver professional value with diverse web-readiness.
                            ...
                            change incubate unique benefits for extensible resources.</p>

                        <div class="feature-content-wrap">
                            <ul class="nav nav-tabs feature-tab" data-tabs="tabs">
                                <li class="nav-item">
                                    <a class="nav-link h6 active" href="#tab6-1" data-toggle="tab">
                                    ...
                                    <ul class="list-unstyled">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <div class="badge badge-circle badge-primary">
                                                        <span><img src="./images/check-solid.svg" alt="check"></span>
                                                    </div>
                                                </div>
                                                <div>
                                        ...
                                        <li class="py-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p class="mb-0">Collaboratively predominate vertical manufactured
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
                                ...
                                <div class="tab-pane" id="tab6-2">
                                    <div class="single-feature">
                                        <div class="d-flex align-items-center mb-2">
                                            <span class="ti-microphone rounded me-3 icon icon-color-1"></span>
                                            <h5 class="mb-0">Easy to use</h5>
                                        </div>
                                        <p>Synergistically deliver next-generation relationships whereas bleeding-edge
                                            resources. Continually pontificate stand-alone benefits whereas.</p>
                                    </div>
                                    <div class="single-feature mb-4">
                                        <div class="d-flex align-items-center mb-2">
                                            <span class="ti-alarm-clock rounded me-3 icon icon-color-2"></span>
                                            <h5 class="mb-0">Increase conversion</h5>
                                        </div>
                                        <p>Phosfluorescently empower compelling intellectual capital and revolutionary
                                            web services. Compellingly develop cross-media.</p>
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab6-3">
                                    <div class="single-feature mb-4">
                                        <div class="d-flex align-items-center mb-2">
                                            <span class="ti-bar-chart rounded me-3 icon icon-color-2"></span>
                                            <h5 class="mb-0">Increase conversion</h5>
                                        </div>
                                    ...
                                    <div class="single-feature mb-4">
                                        <div class="d-flex align-items-center mb-2">
                                            <span class="ti-stats-up rounded me-3 icon icon-color-3"></span>
    ...
    <!-- technologies -->
        ...
        <div class="container text-center">
            <h1 class="mb-5">Our Technologies</h1>
            <div class="row justify-content-center g-0 mb-3">
                <div class="col-lg-2 col-md-2">
                  <img class="technology-img" src="./images/php.png" alt="">
                </div>
                  <div class="col-lg-2 col-md-2">
                   <img class="technology-img" src="./images/laravel.png" alt="">
                </div>
                  <div class="col-lg-2 col-md-2">
                   <img class="technology-img" src="./images/js.png" alt="">
                </div>
                  <div class="col-lg-2 col-md-2">
                   <img class="technology-img" src="./images/node js.png" alt="">
                </div>
                  <div class="col-lg-2 col-md-2">
                    <img class="technology-img" src="./images/codeignitor.png" alt="">
                </div>
                 
            </div>
            <div class="row justify-content-center mb-3 g-0">
                <div class="col-lg-2 col-md-2">
                    <img class="technology-img" src="./images/react.png" alt="">
                </div>
                <div class="col-lg-2 col-md-2">
                    <img class="technology-img" src="./images/bootstrap.png" alt="">
                </div>
                <div class="col-lg-2 col-md-2">
                    <img class="technology-img" src="./images/adobexd.png" alt="">
                </div>
                <div class="col-lg-2 col-md-2">
                    <img class="technology-img" src="./images/figma.png" alt="">
                </div>
                <div class="col-lg-2 col-md-2">
                    <img class="technology-img" src="./images/python.png" alt="">
                </div>
    ...
    <section id="contact" class="contact-us gray-light-bg ptb-100">
        ...
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d55257.46249344313!2d30.956780668488012!3d30.04857795759434!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14585a29f1b324d9%3A0xc5c5525706430b8d!2sSheikh%20Zayed%20City%2C%20Giza%20Governorate!5e0!3m2!1sen!2seg!4v1655405217871!5m2!1sen!2seg"
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="footer-address">
                        ...
                        <p>27 Zayed city main axis, Ebda3 capital, Egypt</p>
                        <ul>
                            <!-- <li><span><strong>Phone:</strong> +61 2 8376 6284</span></li> -->
                            <!-- <li><span><strong>Email:</strong> <a -->
                ...
                <div class="col-md-7">
                    <form action='<?php echo "contactUs/index.php"?>' method="POST" id="contactForm" class="contact-us-form" novalidate="true">
                            ...
                            <div class="col-sm-6 col-12">
                             <div class="form-group">
                               <select class="form-control" name="needs" id="">
                                 ...
                                 <option value="exscript">Existing Script</option>
                        ...
                        <div class="row">
                            <div class="col-sm-12 mt-3">
                                <button type="submit" class="btn solid-btn disabled" id="btnContactUs"
    ...
    <!-- <section class="client-section ptb-100">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div id="container" class="logos">
                    <div class="photobanner">
                        <span><img src="https://www.kotobee.com/img/web/customers/universities/harvard.png"></span>
                        <span><img src="https://www.kotobee.com/img/web/customers/universities/vt.png"></span>
                        <span><img src="https://www.kotobee.com/img/web/customers/universities/colorado.png"></span>
                        <span><img src="https://www.kotobee.com/img/web/customers/universities/texsas.png"></span>
                        <span><img src="https://www.kotobee.com/img/web/customers/corporates/toyota.png"></span>
                        <span><img src="https://www.kotobee.com/img/web/customers/corporates/oracle.png"></span>
                        <span><img src="https://www.kotobee.com/img/web/customers/corporates/nissan.png"></span>
                        <span><img src="https://www.kotobee.com/img/web/customers/corporates/globalbeauty.png"></span>
                        <span><img src="https://www.kotobee.com/img/web/customers/corporates/edex.png"></span>
                        <span><img
                                src="https://www.kotobee.com/img/web/customers/corporates/australianInstituteFitness.png"></span>
    ...
    <footer class="footer-section ptb-100">
        ...
        <div class="footer-top pt-150 background-img-2">
            ...
            <div class="footer-bottom border-gray-light mt-5 pt-3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-lg-7">
                            <div class="copyright-wrap small-text">
                                <p class="mb-0 text-white">© BakerySoft, All rights reserved</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-5">
        ...
        <!-- <div id="smith-container">
            <div class="smith-chat-frame">
                <div class="chat-header">
                    <h6 class="mt-2">Feel free to ask us about anything. Click below to start the conversation.</h6>
                </div>
                <a href="#" target="" rel="nofollow">
                    <div>
                        <div class="chat-body chat-body flex-row justify-content-start text-right">
                            <img loading="lazy" width="100%" height="100%"
                                src="https://theqalink.com/storage/whatsup-options/1645442207.PNG" alt="تواصل مع ثقة"
                                class="img-fluid chat-avatar">
                            <div class="mr-2">
                                <p class="text-muted">Visitor Service Team</p>
                                <h6 class="agent-name">Mohamed Metwally</h6>
                                <p class="status">Avaiable</p>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <div id="launch" class="smith-launcher-frame">
            <div class="smith-launcher">
                <img src="./images/whatsapp-brands.svg" alt="comment">
            </div>
        </div> -->
        <!--livechat top end-->
    ...
    <script>
        document.querySelector("#launch").addEventListener("click", function () {
            document.querySelector("#smith-container").classList.toggle("active");
        });
    </script>
</body>

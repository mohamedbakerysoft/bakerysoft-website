...
@section('content')
    ...
    <section class="shell pt-16">
        ...
        <p class="section-copy">{{ $query !== '' ? 'نتائج مطابقة لعبارة البحث التي أدخلتها، ويمكنك فتح أي أداة لبدء الاستخدام مباشرة.' : 'أدوات حديثة ومحدثة تغطي أكثر السيناريوهات استخدامًا في المال والاستثمار والتحويلات.' }}</p>
        <div class="mt-8">
